...
class Classifier(nn.Module):
    def __init__(self, in_features, num_classes):
        ...
        self.classifier = nn.Sequential(                # 2-Layer MLP to predict the resolution sequence ordering
...
class TripletNet(nn.Module):
    ...
    def __init__(self, model):
        ...
        if model == 'resnet18':
            ...
            self.model = model
            print(self.model)
            self.fc = nn.Sequential(nn.Linear(512*2, 512),    # Pair-wise feature extraction
    ...
    def forward(self, i1, i2, i3):
        ...
        features = torch.cat((f12, f23, f13), dim=1)  # (256 * 3) dim feature vector
